...
-- =====================================================
-- TEMPLATES TABLE (Added: 2025-11-16)
-- =====================================================
...
-- =====================================================
-- CERTIFICATE TYPES TABLE (Added: 2025-11-16)
-- =====================================================
...
-- =====================================================
-- CERTIFICATES TABLE (Added: 2025-11-16)
-- =====================================================
...
-- =====================================================
-- CERTIFICATE HISTORY TABLE (Added: 2025-11-16)
-- =====================================================
...
-- Create indexes for templates, certificate types, certificates, and certificate history
...
-- =====================================================
-- NEW PERMISSIONS (Added: 2025-11-16)
-- =====================================================

-- Template Management Permissions (IDs 131-135)
INSERT INTO permissions (permission_id, permission_name, permission_code, description, module, action, is_active)
VALUES
...
-- Certificate Management Permissions (IDs 141-151)
INSERT INTO permissions (permission_id, permission_name, permission_code, description, module, action, is_active)
VALUES
...
VALUES
  ...
  (1, 141), (1, 142), (1, 143), (1, 144), (1, 145), (1, 146), (1, 147), (1, 148), (1, 149), (1, 150), (1, 151);

-- Assign permissions to CHURCH ADMIN (role_id = 2)
INSERT INTO role_permissions (role_id, permission_id)
VALUES
  -- Template permissions
...
BEGIN
    ...
    RAISE NOTICE 'Permissions seeded: 151 (123 original + 5 templates + 11 certificates + 12 new)';
    RAISE NOTICE 'Subscription plans: 6 (3 active monthly, 3 inactive yearly)';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'New Modules Added (2025-11-16):';
    RAISE NOTICE '- Templates: 1 table, 5 permissions';
    RAISE NOTICE '- Certificates: 3 tables, 11 permissions, 1 function';
    RAISE NOTICE '========================================';
    ...
    RAISE NOTICE '4. Run template & certificate migrations if needed';
    RAISE NOTICE '========================================';
END $$;
